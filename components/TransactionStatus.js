    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="status inline-block align-bottom py-6 bg-white border rounded-lg text-center overflow-hidden
              shadow-xl transform transition-all md:w-[35%] sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <p className="px-4 py-4 text-black items-center text-sm justify-center sm:px-6 sm:flex sm:flex-row-reverse">
                (transaction would usually take &lt; 12sec...)
              </p>
            </div>
          </Transition.Child>
        </div>
